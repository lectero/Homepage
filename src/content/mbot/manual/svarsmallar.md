...
Detta kapitel beskriver hur svarsmallar i MBot ska utformas för att fungera som tillförlitliga, kontrollerade och återanvändbara byggstenar i ett AI-stött e-postflöde. Texten är avsedd både som praktiskt stöd vid mallskrivning och som kvalitetsreferens för att förstå varför vissa mallar fungerar bättre än andra i ett system där mänskligt ansvar alltid är överordnat automatisering.

## Vad en mall är (och vad är den inte)

En mall i MBot är **inte** ett färdigt standardsvar som skickas rakt av till mottagaren. Den är inte heller en generell ”text som brukar fungera”.
...
I MBot skrivs mallar inte som fria texter, utan som strukturerade utkast. Syftet är inte att begränsa uttrycket, utan att säkerställa att relevanta dimensioner alltid övervägs.
...
När en användare har skrivit ett mallutkast kan MBot erbjuda en **förfinad version**, en så kallad *refined template*. Den ersätter inte användarens text, utan fungerar som ett alternativ som kan accepteras, justeras eller avvisas.
...
1.  Behålla originalet (lokalt korrekt, snabbast).

2.  Acceptera refined version (robust standardmall).

3.  Justera refined version mot ett specifikt fall.
