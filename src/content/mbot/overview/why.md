...
- Strukturera inkommande ärenden i en taxonomi som kan förstås av personal.
- Ha en tydlig policy för vad som får automatiseras, och vad som aldrig får automatiseras.
- Låt språkmodellen göra det den är bra på, skriva text.
- Låt deterministiska regler göra det de är bra på, fatta beslut om flöde.

## Resultat man normalt vill åt

- Kortare svarstid för standardärenden.
- Jämnare kvalitet i svar, särskilt i ton och korrekthet.
- Mindre stress på kansliet.
- Bättre beslutsunderlag genom mätbarhet.
